...
<Warning>
  ...
  - **UserProfileV2** → **SocialProfile** (UserProfileV2 cannot be enabled when SocialProfile is active)
  - **Lingo** ↔ **Newsletter** (mutual conflict)
  - **MyVariables** → **ApprovedRevs** (MyVariables cannot be active alongside ApprovedRevs)
</Warning>
